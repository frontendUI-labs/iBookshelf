  ...
  return (
    <Select.Root value={value} onValueChange={onChange}>
      <div className="flex flex-col gap-2">
        <p>{label}</p>
        <Select.Trigger
          className="min-w-[160px] inline-flex items-center justify-between rounded p-6 text-[13px] leading-none h-[35px] gap-[5px] bg-white text-violet11 shadow-[0_2px_10px] shadow-black/10 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-violet9 outline-none"
          aria-label="Genre"
        >
          <Select.Value placeholder="Selecciona un genero" />
